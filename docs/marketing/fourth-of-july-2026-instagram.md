...
2. Export the **5 carousel slides** from `fourth-of-july-launch-carousel.html`
   (open it → DevTools → right-click the `.slide` → *Capture node screenshot* for full-res; or screenshot on a high-res display).
